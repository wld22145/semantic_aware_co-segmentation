...
class model(nn.Module):
    def __init__(self):
        ...
        # encoder
        self.pretrained_model = inception_v3(pretrained=True)
        self.features_map = nn.Sequential(
            self.pretrained_model.Conv2d_1a_3x3,
            self.pretrained_model.Conv2d_2a_3x3,
            self.pretrained_model.Conv2d_2b_3x3,
            self.pretrained_model.Conv2d_3b_1x1,
            self.pretrained_model.Conv2d_4a_3x3,
            self.pretrained_model.Mixed_5b,
            self.pretrained_model.Mixed_5c,
            self.pretrained_model.Mixed_5d,
            self.pretrained_model.Mixed_6a,
            self.pretrained_model.Mixed_6b,
            self.pretrained_model.Mixed_6c,
            self.pretrained_model.Mixed_6d,
            self.pretrained_model.Mixed_6e,
